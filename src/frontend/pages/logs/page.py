        ...
        if self._active_source == "REPORT":
            if 0 <= row < len(self._shown_rows):
                ...
                detail = {
                    ...
                    "retryable": report_row.get("retryable", ""),
                    "failure_step": report_row.get("failure_step", ""),
                    "last_success_step": report_row.get("last_success_step", ""),
                    "debug_steps": report_row.get("debug_steps", []),
