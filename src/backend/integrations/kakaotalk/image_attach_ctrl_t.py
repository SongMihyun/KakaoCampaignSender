# ✅ FILE: src/backend/integrations/kakaotalk/image_attach_ctrl_t.py
...
from backend.integrations.windows.win32_core import close_open_dialog_if_any, ensure_foreground_chat_hwnd
