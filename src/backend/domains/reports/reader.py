    ...
    def _build_recipient_row(
        ...
        *,
        ...
        return {
            ...
            "reason": reason,
            "attempt": attempt,
            "retryable": bool(recipient_obj.get("retryable", False)),
            "failure_step": str(recipient_obj.get("failure_step", "") or ""),
            "last_success_step": str(recipient_obj.get("last_success_step", "") or ""),
            "debug_steps": list(recipient_obj.get("debug_steps", []) or []),
            "message_len": message_len,
            "image_count": image_count,
            "_list_title": title,
